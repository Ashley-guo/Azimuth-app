...
st.set_page_config(
    page_title="The Dark-Night Economy — Azimuth Chapter 1",
    page_icon="🌙",
    layout="wide",
...
def load_state_data():
    try:
        return pd.read_csv("data/state_summary.csv")
    except Exception:
        return None
...
<div style='padding:16px 0 36px;'>
  ...
  <h1 style='font-size:2.8rem;font-weight:800;color:#e2e8f0;
             letter-spacing:-0.04em;line-height:1.08;margin:0 0 28px;'>
    The Dark&#8209;Night Economy™
  </h1>
  ...
  <div style='display:flex;flex-direction:column;gap:10px;max-width:660px;
    ...
    <p style='margin:0;font-size:1rem;color:#94a3b8;line-height:1.7;'>
      Uber found value in <b style='color:#e2e8f0;'>idle car&#8209;hours.</b>
    </p>
    <p style='margin:0;font-size:1rem;color:#94a3b8;line-height:1.7;'>
      Airbnb found value in <b style='color:#e2e8f0;'>empty room&#8209;nights.</b>
    </p>
    <p style='margin:0;font-size:1rem;line-height:1.7;'>
      <b style='color:#fb923c;font-weight:700;'>
        Azimuth finds value in dark venue&#8209;nights.
      </b>
    </p>
  </div>
  ...
  <p style='margin:24px 0 0;font-size:0.9rem;color:#64748b;
    ...
    Live entertainment is not evenly distributed — it clusters around a few
    high&#8209;value nights, revealing an inventory gap the industry has never
...
c2.markdown(kpi(f"{prime_night_events:,}", "Events on Prime Nights<br>Fri · Sat · Sun",     "#f59e0b"), unsafe_allow_html=True)
c3.markdown(kpi(f"{prime_night_share:.1f}%", "of All Events on<br>Just 3 Nights",           "#a78bfa"), unsafe_allow_html=True)
...
<div style='background:#12161f;border:1px solid #1e2535;border-left:3px solid #fb923c;
  ...
  <p style='color:#cbd5e1;font-size:0.92rem;line-height:1.75;margin:0;'>
    ...
    The remaining four weeknights share just <b style='color:#94a3b8;'>{non_prime:,} events</b> —
    less than four-tenths of total demand. Live entertainment is fundamentally a
    <b style='color:#e2e8f0;'>prime-time inventory economy</b>.
  </p>
</div>
""", unsafe_allow_html=True)
...
<h2 style='font-size:1.5rem;font-weight:800;color:#e2e8f0;
  ...
  Live Entertainment Is a Prime-Night Economy
</h2>
<p style='font-size:0.88rem;color:#64748b;margin-bottom:2px;line-height:1.65;'>
  ...
  <span style='color:#fb923c;'>&#9679; Prime nights</span>
  vs.
  <span style='color:#334155;'>&#9679; Off-nights</span> —
...
fig1.add_annotation(
    ...
    text="Peak night<br>24.4% of all events",
...
with col_ia:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-top:2px solid #fb923c;
      ...
      <div style='font-size:0.68rem;font-weight:600;color:#4b5675;text-transform:uppercase;
                  letter-spacing:0.08em;margin-bottom:8px;'>Weekend vs. Weekday Split</div>
...
with col_ib:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-top:2px solid #f59e0b;
      ...
      <p style='color:#cbd5e1;font-size:0.88rem;line-height:1.7;margin:0;'>
        Saturday is the single largest event night at
...
<h2 style='font-size:1.5rem;font-weight:800;color:#e2e8f0;
           letter-spacing:-0.02em;margin-bottom:4px;'>
  Prime Nights Capture the Majority of Live Activity
</h2>
<p style='font-size:0.88rem;color:#64748b;margin-bottom:8px;line-height:1.65;'>
  Three nights vs. four nights — the demand split is not close.
</p>
""", unsafe_allow_html=True)
...
with col_donut:
    fig2 = go.Figure(go.Pie(
        labels=["Prime Nights  (Fri / Sat / Sun)", "Off Nights  (Mon – Thu)"],
    ...
    fig2.add_annotation(
        text=(
            ...
            "<span style='font-size:11px;color:#64748b;'>Prime-Night</span><br>"
            "<span style='font-size:11px;color:#64748b;'>Share</span>"
        ),
        x=0.5, y=0.5,
        showarrow=False,
...
with col_dinsight:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-radius:10px;
      ...
      <div style='display:flex;gap:12px;margin-bottom:18px;'>
        ...
        <div>
          <div style='color:#fb923c;font-weight:700;font-size:0.9rem;
                      margin-bottom:5px;'>3 Prime Nights</div>
      ...
      <div style='display:flex;gap:12px;margin-bottom:22px;'>
        ...
        <div>
          <div style='color:#64748b;font-weight:700;font-size:0.9rem;
                      margin-bottom:5px;'>4 Off Nights</div>
      ...
      <p style='color:#94a3b8;font-size:0.87rem;line-height:1.75;margin:0;'>
        If a venue is <b style='color:#e2e8f0;'>dark on Friday or Saturday</b>,
        it is missing its most valuable inventory window — not a slow week,
        but a systematic loss of peak-demand nights.
...
<div style='padding:28px 32px;background:#12161f;border:1px solid #1e2535;
  ...
  <p style='color:#e2e8f0;font-size:1.05rem;font-weight:500;
    ...
    Uber found value in <b>idle car-hours</b>.<br>
    Airbnb found value in <b>empty room-nights</b>.<br>
    <span style='color:#fb923c;font-weight:700;'>Azimuth finds value in dark venue-nights.</span>
  </p>
  <p style='color:#64748b;font-size:0.9rem;line-height:1.75;margin:0;'>
    ...
    clustering on just three nights, the real opportunity is not in building more venues —
    it is in identifying which proven stages sit dark on their highest-value nights.
...
# ══════════════════════════════════════════════════════════════════════════════
# CHAPTER 2 — Venues Monetize Only on Peak Nights
...
def load_venue_prime():
    df = pd.read_csv("data/venue_prime_night_dependence.csv")
...
<div style='padding:8px 0 26px;'>
  ...
  <h1 style='font-size:2.6rem;font-weight:800;color:#e2e8f0;
    ...
    Venues Monetize Only on Peak Nights
  </h1>
  <p style='font-size:0.97rem;color:#64748b;max-width:720px;line-height:1.8;
    ...
    Venue activity concentrates around a few high-value nights, leaving large portions
    of the weekly calendar structurally dark.
...
with ub1:
    ...
    <div style='background:#0f1420;border:1px solid #1e2535;border-radius:10px;
      ...
      <p style='color:#94a3b8;font-size:0.9rem;line-height:1.7;margin:0;'>
        ...
        It found cars that were <b style='color:#cbd5e1;'>sitting idle</b>
        between rides and created a market for those hours.
      </p>
    </div>
    """, unsafe_allow_html=True)
with ub2:
    ...
    <div style='background:#0f1420;border:1px solid #1e2535;border-radius:10px;
      ...
      <p style='color:#94a3b8;font-size:0.9rem;line-height:1.7;margin:0;'>
        ...
        It found rooms that sat <b style='color:#cbd5e1;'>empty most nights</b>
        and turned that idle inventory into revenue.
      </p>
    </div>
    """, unsafe_allow_html=True)
with ub3:
    ...
    <div style='background:#16100a;border:2px solid #fb923c;border-radius:10px;
      ...
      <p style='color:#fb923c;font-size:0.9rem;line-height:1.7;margin:0;font-weight:600;'>
        ...
        It identifies stages that are <b>dark on weeknights</b>
        and activates those calendar gaps as live entertainment inventory.
      </p>
    </div>
    """, unsafe_allow_html=True)
st.markdown("<div style='height:18px'></div>", unsafe_allow_html=True)
...
vc2.markdown(kpi(f"{v_avg_prime:.1f}%",
                 "Avg Prime-Night Share<br>Fri · Sat · Sun",
                 "#f59e0b"), unsafe_allow_html=True)
vc3.markdown(kpi(f"{v_extreme:,}",
                 f"Venues ≥80% Prime-Night<br>Extreme Dependence · {v_extreme_pct:.0f}% of Total",
                 "#fb923c"), unsafe_allow_html=True)
vc4.markdown(kpi(f"{v_avg_off:.1f}%",
                 "Avg Off-Night Share<br>Mon · Tue · Wed · Thu",
...
<div style='background:#12161f;border:1px solid #1e2535;border-left:3px solid #fb923c;
  ...
  <p style='color:#cbd5e1;font-size:0.92rem;line-height:1.8;margin:0;'>
    ...
    Their Monday-through-Thursday calendar is largely inactive —
    not a capacity problem, but a <b style='color:#e2e8f0;'>temporal utilisation gap</b>.
  </p>
</div>
""", unsafe_allow_html=True)
...
with mc1:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-top:2px solid #334155;
      ...
      <p style='color:#94a3b8;font-size:0.87rem;line-height:1.75;margin:0 0 14px;'>
        ...
        They were built that way. Their prime-night concentration tells us nothing
...
with mc2:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-top:2px solid #fb923c;
      ...
      <p style='color:#cbd5e1;font-size:0.87rem;line-height:1.75;margin:0 0 14px;'>
        ...
        in principle host events on any night of the week.
      </p>

      <p style='color:#cbd5e1;font-size:0.87rem;line-height:1.75;margin:0 0 14px;'>
        These venues have no scheduling constraint forcing them into weekends.
        And yet the pattern holds: <b style='color:#fb923c;'>their event activity is still
      ...
      <div style='background:#1a0e00;border:1px solid #fb923c;border-radius:6px;
        ...
        If even non-festival venues show 62% average prime-night concentration,
...
# ══════════════════════════════════════════════════════════════════════════════
# CHART A — Prime-Night Dependence Curve (histogram)
# Question answered: "How many venues are structurally locked into peak nights?"
...
<h2 style='font-size:1.5rem;font-weight:800;color:#e2e8f0;
           letter-spacing:-0.02em;margin-bottom:4px;'>
  Prime-Night Dependence Curve
</h2>
<p style='font-size:0.88rem;color:#64748b;margin-bottom:6px;line-height:1.65;'>
  How to read this chart: every bar is a bucket of venues sharing a similar prime-night share.
  Bars toward the <b style='color:#38bdf8;'>left (blue)</b> = venues whose events spread relatively
  evenly across the week. Bars toward the <b style='color:#fb923c;'>right (orange)</b> = venues
  that are economically active only on Friday–Sunday.
...
fig_hist.add_annotation(
    x=80, y=y_ceil * 0.93,
    text="<b>80% Threshold</b><br>Extreme Weekend Dependence",
...
fig_hist.update_layout(
    ...
    xaxis=dict(
        title=dict(text="Prime-Night Share  (%)", font=dict(size=13, color="#64748b")),
...
with ri1:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-left:3px solid #38bdf8;
      ...
      <p style='color:#94a3b8;font-size:0.84rem;line-height:1.65;margin:0;'>
        ...
        These stages attract audiences consistently across the week —
        more like a restaurant with steady covers every night than a
        venue that only opens on Saturday. Rare in this market.
      </p>
    </div>
    """, unsafe_allow_html=True)
with ri2:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-left:3px solid #f59e0b;
      ...
      <p style='color:#94a3b8;font-size:0.84rem;line-height:1.65;margin:0;'>
        ...
        some weekday activity — partial utilisation, partial dark nights.
        Most booking platforms treat these as "fully used" when in fact
        large portions of their calendar remain idle.
      </p>
    </div>
    """, unsafe_allow_html=True)
with ri3:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-left:3px solid #fb923c;
      ...
      <p style='color:#94a3b8;font-size:0.84rem;line-height:1.65;margin:0;'>
        ...
        4 out of every 5 events fall on just three nights.
        Their Mon–Thu calendar is structurally empty.
        <b style='color:#e2e8f0;'>This is Azimuth's primary target inventory.</b>
      </p>
    </div>
    """, unsafe_allow_html=True)
...
with h_ia:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-top:2px solid #fb923c;
                border-radius:8px;padding:18px 20px;'>
      <div style='font-size:0.68rem;font-weight:600;color:#4b5675;text-transform:uppercase;
                  letter-spacing:0.08em;margin-bottom:8px;'>Extreme Zone  (≥80% Prime-Night)</div>
      <p style='color:#cbd5e1;font-size:0.88rem;line-height:1.7;margin:0;'>
        <b style='color:#fb923c;'>{v_extreme:,} venues</b> run 80%+ of all events on Fri–Sun.
...
with h_ib:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-top:2px solid #475569;
                border-radius:8px;padding:18px 20px;'>
      <div style='font-size:0.68rem;font-weight:600;color:#4b5675;text-transform:uppercase;
                  letter-spacing:0.08em;margin-bottom:8px;'>Balanced Zone  (&lt;40% Prime-Night)</div>
      <p style='color:#94a3b8;font-size:0.88rem;line-height:1.7;margin:0;'>
        Only <b style='color:#38bdf8;'>{v_balanced:,} venues</b>
        ({v_balanced / v_total * 100:.0f}% of the market) distribute events
        relatively evenly across the week.
        Weekend concentration is the structural norm, not the exception.
      </p>
    </div>
    """, unsafe_allow_html=True)
...
# ══════════════════════════════════════════════════════════════════════════════
# CHART B — Bubble Scatter: "Where Venue Activity Becomes Peak-Time Locked"
...
<h2 style='font-size:1.5rem;font-weight:800;color:#e2e8f0;
           letter-spacing:-0.02em;margin-bottom:4px;'>
  Where Venue Activity Becomes Peak-Time Locked
</h2>
<p style='font-size:0.88rem;color:#64748b;margin-bottom:6px;line-height:1.65;'>
  ...
  is concentrated on prime nights. Bubble size reflects venue capacity.
  The <b style='color:#fb923c;'>upper-right corner</b> is the most commercially important zone:
  venues that are proven, high-capacity, <i>and</i> structurally dependent on three nights a week.
  That is where dark-night inventory is most valuable.
</p>
""", unsafe_allow_html=True)
...
fig_sc.add_hline(
    ...
    annotation_text="  80% — Extreme Dependence Threshold",
...
for tier, (color, opacity) in TIER_STYLE.items():
    ...
    fig_sc.add_trace(go.Scatter(
        ...
        hovertemplate=(
            ...
            "Events: <b>%{x:,}</b>  ·  Prime-Night: <b>%{y:.1f}%</b><br>"
            "Capacity: %{customdata[3]}  ·  Off-Night: %{customdata[4]:.1f}%"
            "<extra></extra>"
        ),
    ))
...
fig_sc.add_annotation(
    x=x_cap * 0.72, y=94,
    text="<b>HIGH HISTORY · PEAK-TIME LOCKED</b><br>Proven assets — dark most of the week",
    showarrow=False,
    font=dict(size=11, color="#fb923c", family="Inter, sans-serif"),
...
with sc_ia:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-top:2px solid #38bdf8;
      ...
      <p style='color:#94a3b8;font-size:0.84rem;line-height:1.65;margin:0;'>
        Venues with fewer events but balanced prime-night share.
        Small stages or newer venues that have found a pattern of even usage.
        Limited inventory value, but they demonstrate the model is possible.
      </p>
    </div>
    """, unsafe_allow_html=True)
with sc_ib:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-top:2px solid #f59e0b;
      ...
      <p style='color:#94a3b8;font-size:0.84rem;line-height:1.65;margin:0;'>
        ...
        These have the most immediately improvable off-night utilisation —
        they already host some weekday events, so the audience behaviour is
        partially trained. Adding off-night inventory here has the lowest friction.
      </p>
    </div>
    """, unsafe_allow_html=True)
with sc_ic:
    ...
    <div style='background:#12161f;border:1px solid #1e2535;border-top:2px solid #fb923c;
                border-radius:8px;padding:16px 18px;'>
      <div style='font-size:0.65rem;font-weight:700;color:#c2410c;text-transform:uppercase;
                  letter-spacing:0.1em;margin-bottom:8px;'>Upper-Right — Peak-Time Locked</div>
      <p style='color:#94a3b8;font-size:0.84rem;line-height:1.65;margin:0;'>
        High event history. High prime-night dependence. Large bubbles signal significant
        ...
        but only on three nights a week. Their weekday calendar is effectively for sale.
      </p>
    </div>
    """, unsafe_allow_html=True)
...
# ══════════════════════════════════════════════════════════════════════════════
# LEADERBOARD — Top 25 Most Prime-Night Dependent Venues
# ══════════════════════════════════════════════════════════════════════════════

st.markdown("""
<h2 style='font-size:1.5rem;font-weight:800;color:#e2e8f0;
           letter-spacing:-0.02em;margin-bottom:4px;'>
  Most Prime-Night Dependent Venues
</h2>
""", unsafe_allow_html=True)
...
<div style='background:#12161f;border:1px solid #1e2535;border-left:3px solid #f59e0b;
  ...
  <p style='color:#cbd5e1;font-size:0.88rem;line-height:1.8;margin:0 0 10px;'>
    These are venues with <b style='color:#e2e8f0;'>100% (or near-100%) prime-night
    share and meaningful event histories</b> — they are not data anomalies.
  ...
  <p style='color:#94a3b8;font-size:0.87rem;line-height:1.8;margin:0 0 10px;'>
    And yet: their Off-Night Events column is near zero.
    That is not because no one wants to attend events on a Tuesday —
    it is because <b style='color:#e2e8f0;'>no one has ever systematically offered them one at these venues</b>.
    The demand signal has never been tested. The inventory has never been activated.
  </p>
  <p style='color:#94a3b8;font-size:0.87rem;line-height:1.8;margin:0 0 10px;'>
  ...
  <p style='color:#fb923c;font-size:0.87rem;line-height:1.8;margin:0;font-weight:600;'>
    Their weekday calendar inventory is effectively unsold. Azimuth is the market that buys it.
  </p>
</div>
""", unsafe_allow_html=True)
...
st.dataframe(
    ...
    column_config={
        ...
        "prime_night_events": st.column_config.NumberColumn("Prime-Night Events", format="%d"),
        "off_night_events":   st.column_config.NumberColumn("Off-Night Events",   format="%d"),
        "prime_night_share":  st.column_config.ProgressColumn(
            "Prime-Night %", min_value=0, max_value=100, format="%.1f%%"),
        "off_night_share":    st.column_config.ProgressColumn(
            "Off-Night %",   min_value=0, max_value=100, format="%.1f%%"),
    },
)
...
<div style='margin-top:4px;margin-bottom:8px;padding:32px 38px;
  ...
  <p style='color:#e2e8f0;font-size:1.1rem;font-weight:700;
    ...
    The issue is not venue scarcity. The issue is temporal utilisation inefficiency.
  </p>

  <p style='color:#94a3b8;font-size:0.92rem;line-height:1.85;margin:0 0 18px;'>
    Uber found value not by building more cars but by asking:
    <i>when are existing cars idle?</i><br>
    Airbnb found value not by building more hotels but by asking:
    <i>when are existing rooms empty?</i><br>
    <b style='color:#fb923c;'>Azimuth finds value by asking: when are existing venues dark?</b>
  </p>

  <p style='color:#64748b;font-size:0.9rem;line-height:1.8;margin:0;'>
    Across {v_total:,} established venues,
    <b style='color:#fb923c;'>{v_extreme:,} ({v_extreme_pct:.0f}%)</b>
    run 80% or more of their events within a single three-night window.
    Their Monday-through-Thursday calendars are structurally underused —
    not because demand is absent, but because no coordination layer has ever existed
    to activate it efficiently.<br><br>
    Azimuth's opportunity is to convert those dark weekday nights into
    <b style='color:#fb923c;'>programmable, monetisable live entertainment inventory</b>.
